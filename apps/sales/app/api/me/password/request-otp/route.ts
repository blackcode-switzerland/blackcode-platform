...
//
// b/sales could not mount this until `packages/platform-email` existed
// (2026-08-11). Before that, Settings → Account sent people to another app to
// change a password that was already shared with this one.
