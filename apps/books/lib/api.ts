...
/**
 * THIS APP'S WORKSPACES ARE `books.workspaces` (Phase 7, 2026-08-11).
 *
...
const noUploadLedger: UploadLedger = {
  attribute: async () => {
    throw new Error(
      'apps/books records no uploads: it serves no /api/upload route. If you ' +
...
export const appContext: AppContext = {
  ...
  // Its own, since 2026-08-11. See `booksWorkspaceSource` above.
  //
  ...
  workspaces: booksWorkspaceSource,
  ...
  footprint: booksFootprintSource,
  ...
  // No `manifest`: this app has no agent landing page, and a X-BK-Help
