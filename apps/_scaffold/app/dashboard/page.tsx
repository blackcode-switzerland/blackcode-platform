...
// the one page this scaffold has behind a login.
//
// ===========================================================================
    ...
    return (
      <main style={{ fontFamily: 'system-ui', padding: 48, maxWidth: 640 }}>
        ...
        <p>
          ...
          <code>scaffold.workspaces</code>, not at the status code, because that call never throws
          into a sign-in.
        </p>
      </main>
    )
      ...
      {isOwner && (
        <>
          ...
          {invitations.length === 0 ? (
            <p>
              None. Invite somebody with <code>bk scaffold invite send &lt;email&gt;</code>; the
