...
// The sign-in form. Deliberately unstyled beyond the minimum: a starting point that
...
// dependency so its login page can have a spinner is how a starting point becomes
