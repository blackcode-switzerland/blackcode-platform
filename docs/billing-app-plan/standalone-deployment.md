...
| Version constants | [`cli-version.ts:40`](../../packages/platform-agent/src/cli-version.ts#L40) `CLI_LATEST_VERSION`, `CLI_MIN_VERSION`, and the `BK_CLI_*` env names | reset to `1.0.0` in the artifact; theirs from then on |
