...
export const en = {
  ...
  // ── profile ─────────────────────────────────────────────────────────────
  'settings.profile.title': 'Your {platform} profile',
  ...
  'settings.account.signedInNote':
    'One account, one sign-in, every {platform} app. Signing out here signs you out everywhere.',
  'settings.account.password': 'Password',
  'settings.account.passwordNote':
    'One password for every {platform} app. Changing it here signs you out everywhere, including this session.',
  'settings.account.passwordViaGoogle':
    'You sign in with Google, so there is no {platform} password to change here. Google owns that credential and it is changed in your Google account.',
  'settings.account.changePassword': 'Change password',
  'settings.account.dataTitle': 'Your {app} data',
  ...
  'settings.account.dataBody':
    'Art. 958f CO requires the books and their supporting documents to be kept for ten years, and the database refuses the delete rather than relying on anybody remembering. Other apps offer to remove your data; this one is not able to, and what closing a {platform} account means for accounting records has not been settled.',
  'settings.account.dataWarning':
    'Ask before you close a {platform} account from another app, rather than closing it and finding out what happened to the books afterwards.',
  'settings.account.elsewhere': 'Elsewhere in {platform}',
  ...
  'settings.account.noOtherApps':
    'No other {platform} app is registered in this deployment’s address book.',
  'settings.account.platformWide':
    'Users, error events and the drift reconcilers are platform-wide — the same rows whichever app you ask. {app} has no administration screens of its own and will not grow any.',
  ...
  'settings.tokens.newNote':
    'Tokens are how agents reach {platform}. This one works against every app your account can reach, not only {app}.',
  ...
  'settings.languageNote':
    'Stored on your {platform} account, not in this browser — so it follows you to every {platform} app and to every machine you sign in on.',
  ...
  'settings.languageBrowserNote':
    'No stored preference — {app} uses your browser’s language and falls back to English.',
...
export const fr: Record<keyof typeof en, string> = {
  ...
  'settings.profile.title': 'Votre profil {platform}',
  'settings.profile.note':
  ...
  'settings.account.signedInNote':
    'Un compte, une connexion, toutes les applications {platform}. Vous déconnecter ici vous déconnecte partout.',
  'settings.account.password': 'Mot de passe',
  'settings.account.passwordNote':
    'Un seul mot de passe pour toutes les applications {platform}. Le changer ici vous déconnecte partout, y compris de cette session.',
  'settings.account.passwordViaGoogle':
    'Vous vous connectez avec Google : il n’y a donc pas de mot de passe {platform} à changer ici. Cet identifiant appartient à Google et se modifie dans votre compte Google.',
  'settings.account.changePassword': 'Changer le mot de passe',
  'settings.account.dataTitle': 'Vos données {app}',
  'settings.account.dataLead':
  ...
  'settings.account.dataBody':
    'L’art. 958f CO exige la conservation des livres et de leurs pièces justificatives pendant dix ans ; la base de données refuse la suppression plutôt que de compter sur la mémoire de quiconque. D’autres applications proposent d’effacer vos données ; celle-ci n’en a pas la possibilité, et les conséquences de la fermeture d’un compte {platform} sur des documents comptables n’ont pas encore été tranchées.',
  'settings.account.dataWarning':
    'Renseignez-vous avant de fermer un compte {platform} depuis une autre application, plutôt que de le fermer et de découvrir ensuite ce qu’il est advenu des livres.',
  'settings.account.elsewhere': 'Ailleurs dans {platform}',
  'settings.account.elsewhereNote':
    'Votre compte est une seule ligne partagée par toutes les applications. Voici les autres endroits où il fonctionne.',
  'settings.account.noOtherApps':
    'Aucune autre application {platform} n’est inscrite dans l’annuaire de ce déploiement.',
  'settings.account.platformWide':
    'Les utilisateurs, les journaux d’erreurs et les réconciliateurs sont communs à toute la plateforme — ce sont les mêmes lignes quelle que soit l’application interrogée. {app} n’a pas d’écran d’administration propre et n’en aura pas.',
  ...
  'settings.tokens.newNote':
    'Les jetons sont le moyen par lequel les agents accèdent à {platform}. Celui-ci fonctionne avec toutes les applications accessibles à votre compte, pas seulement {app}.',
  ...
  'settings.languageNote':
    'Enregistrée sur votre compte {platform}, pas dans ce navigateur — elle vous suit donc dans toutes les applications {platform} et sur toutes les machines où vous vous connectez.',
  'settings.languageStatutory':
  ...
  'settings.languageBrowserNote':
    'Aucune préférence enregistrée — {app} utilise la langue de votre navigateur et revient à l’anglais à défaut.',
